	...
	<?php
		while ($row = mysqli_fetch_array($result)) { ?>
			<tr>
				...
				<td type="button" class ="upt_btn" name="upt_btn" id="upt_btn">Update</a></td>
			</tr>	
		<?php
		}
	 ?>
...
{
	$results = mysqli_query($db , "UPDATE menu SET food ='". $_POST['food_name'] ."', price = '" . $_POST['price'] ."' , description = '" . $_POST['description'] ."' WHERE food_id = '" .  $_POST['food_id'] . "'" );
}else
{
	?>
	<form method="post">
		<table width="400" border="0" cellspacing="1" cellpadding="2">
			...
			<tr>
				<td width="100">Food Price</td>
				<td><input type="text" name="price" id="price"></td>
			</tr>
			<tr>
				<td width="100">Food Description</td>
				<td><input type="text" name="description" id="description"></td>
			</tr>
			<tr>
				<td width="100"></td>
				<td><input type="submit" name="upt_btn" id="upt_btn" value="Update"></td>
			</tr>
		</table>
	</form>
<?php	
